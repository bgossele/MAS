 ...
 */
public final class CustomWarehouseRenderer implements CanvasRenderer {
  /**
  ...
  private final CustomCollisionGraphRoadModel model;
  ...
  CustomWarehouseRenderer(Builder builder, CustomCollisionGraphRoadModel m) {
    model = m;
  ...
  public static class Builder implements CanvasRendererBuilder {
     ...
     */
    public Renderer[] setMargin(double m) {
      checkArgument(m >= 0d);
      margin = m;
      return this;
    }
    ...
    public CanvasRenderer build(ModelProvider mp) {
      return new CustomWarehouseRenderer(this,
          mp.getModel(CustomCollisionGraphRoadModel.class));
    }
