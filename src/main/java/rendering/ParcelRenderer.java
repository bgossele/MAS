 ...
 */
public final class ParcelRenderer implements ModelRenderer {
   ...
   */
  @Deprecated
  public ParcelRenderer(UiSchema schema, boolean useEncirclement) {
   ...
   */
  @Deprecated
  public ParcelRenderer(@Nullable ViewRect rect, @Nullable UiSchema schema,
  ...
  ParcelRenderer(@Nullable VirtualRoadModel rm, Optional<ViewRect> rect,
  ...
  /**
   * Constructs a {@link Builder} for building {@link ParcelRenderer}
   * instances.
  ...
  /**
   * Builder for {@link ParcelRenderer}.
  ...
  public static class Builder implements CanvasRendererBuilder {
    ...
    public CanvasRenderer build(ModelProvider mp) {
      ...
      return new ParcelRenderer(rm, viewRect, uiSchema, useEncirclement);
    }
